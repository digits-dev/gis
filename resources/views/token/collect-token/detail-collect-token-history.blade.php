                    ...
                    <tbody>
                        @foreach ($collected_tokens->lines as $perLine)
                            <tr>
                                ...
                                <td><span class="jan#">{{ $perLine->jan_number}}</span></td>
                                <td><span class="jan#">{{ $perLine->item_description}}</span></td> 
                                ...
                                <td><span class="projectedCapsuleSales">{{$perLine->actual_capsule_sales}}</span></td>
                                <td><span class="currentMachineInventory">{{$perLine->current_capsule_inventory}}</span></td>
                                <td>

...
<form action="{{ CRUDBooster::mainpath('edit-save/'.$pulloutToken->pt_id) }}" method="POST" id="receiveToken" enctype="multipart/form-data">
    <input type="hidden" value="{{csrf_token()}}" name="_token" id="token">
    <input type="hidden" value="{{ $pulloutToken->pt_id }}" name="pullout_id" id="pullout_id">
    <input type="hidden" value="{{ $pulloutToken->qty }}" name="released_qty" id="released_qty">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control finput" style="" value="{{ $pulloutToken->reference_number }}" readonly>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="require control-label"> From:</label>
                        <input type="text" class="form-control finput" style="" value="{{ $pulloutToken->from_location }}" readonly>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="require control-label"> To:</label>
                        <input type="text" class="form-control finput" style="" value="{{ $pulloutToken->to_location }}" readonly>
                    </div>
                </div>
            </div>
            <div class="row">

<?php namespace App\Http\Controllers\Capsule;
	...
	class AdminHistoryCapsulesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Capsule Action Types Id','name'=>'capsule_action_types_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'capsule_action_types,id'];
			...
			//$this->form[] = ["label"=>"Capsule Action Types Id","name"=>"capsule_action_types_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"capsule_action_types,id"];
			...
			//$this->form[] = ["label"=>"Gasha Machines Id","name"=>"gasha_machines_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"gasha_machines,id"];

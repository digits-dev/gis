...
<div class="panel panel-default form-content" style="overflow: hidden" id="collect_token_details">
    ...
    <div class="content-panel">
        <input type="hidden" name="collectedTokenHeader_id" id="collectedTokenHeader_id" value="{{$collected_tokens_history->id}}" readonly>
            <div class="inputs-container" style="margin-bottom: 10px;">
                <div class="input-container">
                    <div style="font-weight: 600">Reference Number</div>
                    <input type="text" style="border-radius: 5px;" value="{{$collected_tokens_history->reference_number}}" disabled>
                </div>

                <div class="input-container">
                    <div style="font-weight: 600" >Date Created</div>
                    <input type="text" style="border-radius: 5px;" value="{{$collected_tokens_history->created_at}}" disabled>
                </div>
            ...
            <div class="inputs-container" style="margin-bottom: 10px;">
                <div class="input-container">
                    ...
                    <input type="text" style="border-radius: 5px;" value="{{$collected_tokens_history->getLocation->location_name}}" disabled>
                </div>
                <div class="input-container">
                    <div style="font-weight: 600">Bay</div>
                    <input type="text" style="border-radius: 5px;" value="{{$collected_tokens_history->getBay->name}}" disabled>
                </div>
            ...
            <div class="table-wrapper custom-scroll-x">
                <table>
                    ...
                    <tbody>
                        @foreach ($collected_tokens_history->history_lines as $perLine)
                            
                                <tr>
                                    <td><span>{{$perLine->get_serial_number->serial_number}}</span></td>
                                    ...
                                    <td>
                                        ...
                                        @elseif(!empty($collected_tokens_history->confirmed_by))
                                    ...
                                    <td>
                                        @if(empty($collected_tokens_history->confirmed_by))
                                            @php
                                                $currentMachineInventory = $perLine->qty; 
                                            @endphp
...
<div class="chat-container" id="chat-container" style="display: none">
    ...
    <div class="body-chat-container">
            <input type="hidden" name="message_collect_token_id" id="message_collect_token_id" value="{{$collected_tokens_history->id}}" readonly>
            @foreach ($collected_tokens_history->collectTokenMessages as $perMessage)

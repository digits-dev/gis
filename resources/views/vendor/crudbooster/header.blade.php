...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH'))}}" title='{{Session::get('appname')}}' class="logo" style="display: flex; justify-content: center; align-items: center; gap:10px;">
        <img src="{{ asset('img/gislogo.png') }}" style="width: 40px; height:40px;">
        <span style="font-weight: 600">{{CRUDBooster::getSetting('appname')}}</span>
    </a>

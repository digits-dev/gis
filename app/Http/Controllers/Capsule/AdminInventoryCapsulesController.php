<?php namespace App\Http\Controllers\Capsule;
	...
	class AdminInventoryCapsulesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Onhand Qty','name'=>'onhand_qty','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Onhand Qty","name"=>"onhand_qty","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];

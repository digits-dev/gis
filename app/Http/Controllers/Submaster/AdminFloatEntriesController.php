<?php namespace App\Http\Controllers\Submaster;
	...
	class AdminFloatEntriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required','width'=>'col-sm-5','dataenum'=>'ACTIVE;INACTIVE','value'=>'ACTIVE'];			# END FORM DO NOT REMOVE THIS LINE
